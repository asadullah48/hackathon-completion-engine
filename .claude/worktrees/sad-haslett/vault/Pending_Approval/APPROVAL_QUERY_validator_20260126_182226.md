...
created: 2026-01-26T18:22:26.009286
pattern_matched: (exam|test|quiz)\s+(tomorrow|today|in\s+\d+\s+(hour|minute))
status: pending
---
...
## Query Content
```
exam tomorrow I urgently need help
```
